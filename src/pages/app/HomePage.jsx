            ...
            <div className="grid">
                <div className='col-12 lg:col-6 xl:col-3'>
                    <div className='card mb-0'>
                        <div className='flex'>
                            <Avatar className="p-overlay-badge mr-3" image="https://www.primefaces.org/primereact/images/organization/walter.jpg" size="xlarge">
                            </Avatar>
                            <h4 className='align-self-center mb-'>
                                Julio Cesar
                            </h4>
                        </div>
